...
Source Code for the 3.1 version of Dave and Bambi: Vs. 480
...
If you wish to disable things like _Lua Scripts_ or _Video Cutscenes_, you can refer to the `Project.xml` file.

Inside `Project.xml`, you will find several variables to customize Psych Engine to your liking.

To start you off, disabling _Video Cutscenes_ should be simple, simply delete the line `"VIDEOS_ALLOWED"` or comment it out by wrapping the line in XML-like comments, like this: `<!-- YOUR_LINE_HERE -->`
